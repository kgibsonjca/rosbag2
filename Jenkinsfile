...
//                }
                ...
                stage('Build'){
                        ...
                        parallel{
                                stage('Build amd64') {
                                        steps {
                                                sh("tree")
                                                sh("docker run --rm --name ros2-build-amd64 -e BRANCH_NAME -e BUILD_NUMBER -v $PWD:/home/jca/workspace/src/package --entrypoint \"/home/jca/workspace/src/package/build_package.sh\" -t ${ros_build_registry}/amd64/${ros_build_image}")
                                        }
                                }
 ...
 //                               }
                                ...
                                stage('Build arm64') {
                                        steps {
                                                sh("docker run --rm --name ros2-build-arm64 -e BRANCH_NAME -e BUILD_NUMBER -v $PWD:/home/jca/workspace/src/package --entrypoint \"/home/jca/workspace/src/package/build_package.sh\" -t ${ros_build_registry}/arm64/${ros_build_image}")
                                        }
                                }
                        }
                }
